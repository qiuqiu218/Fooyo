...
<head>
	<meta charset="UTF-8">
<title>联系我们 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品</title>
<meta name="robots" content="noodp">
<link rel="canonical" href="http://www.fooyo.sg/zh/%e8%81%94%e7%b3%bb%e6%88%91%e4%bb%ac/">
<meta property="og:locale" content="zh_CN">
<meta property="og:locale:alternate" content="en_US">
<meta property="og:type" content="article">
<meta property="og:title" content="联系我们 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
<meta property="og:url" content="http://www.fooyo.sg/zh/%e8%81%94%e7%b3%bb%e6%88%91%e4%bb%ac/">
<meta property="og:site_name" content="Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="联系我们 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
		<meta property="og:title" content="Fooyo浮游科技|和浮游, 一起打造梦想的科技产品联系我们 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
		<meta property="og:url" content="http://www.fooyo.sg/zh/%e8%81%94%e7%b3%bb%e6%88%91%e4%bb%ac/">
		<meta property="og:site_name" content="Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
...
<?php get_header();?>
			...
			<div class="banner">
			<img src="<?php bloginfo('template_url'); ?>/images/fooyo_contact_02.jpg">
		</div>
		<div class="contact">
			<ul class="clearfix">
				<li>
					<h1>欢迎</h1>
					<div>
						<p><?php $name = get_post_meta($post->ID, '地址', true); if ($name) { echo "$name";}?></p>
						<div>
						<p></em><?php $name = get_post_meta($post->ID, '邮编', true); if ($name) { echo "$name";}?></p>
						<p></em><?php $name = get_post_meta($post->ID, '手机', true); if ($name) { echo "$name";}?></p>
						<p><?php $name = get_post_meta($post->ID, '电子邮箱', true); if ($name) { echo "$name";}?></p>
						</div>
					</div>
				</li>
				<li>
					<h1>欢迎</h1>
					<div>
						<p><?php $name = get_post_meta($post->ID, '地址二', true); if ($name) { echo "$name";}?></p>
						<div>
						<p></em><?php $name = get_post_meta($post->ID, '邮编', true); if ($name) { echo "$name";}?></p>
						<p></em><?php $name = get_post_meta($post->ID, '手机', true); if ($name) { echo "$name";}?></p>
						<p><?php $name = get_post_meta($post->ID, '电子邮箱', true); if ($name) { echo "$name";}?></p>
