...
<head>
	<meta charset="UTF-8">
<meta name="description" content="Bring your business out of the Stone Age with the innovative web, Android and iOS development services from Fooyo in Singapore. Call (+65) 8412 7233 today!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
<meta name="robots" content="noodp">
<meta property="og:locale" content="en_US">
<meta property="og:locale:alternate" content="zh_CN">
<meta property="og:type" content="article">
<meta property="og:title" content="Android and IOS App Developer Singapore">
<meta property="og:description" content="Bring your business out of the Stone Age with the innovative web, Android and iOS development services from Fooyo in Singapore. Call (+65) 8412 7233 today!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
<meta property="og:url" content="http://www.fooyo.sg/cases/">
<meta property="og:site_name" content="Fooyo|With fooyo, building dreams">
<meta name="twitter:card" content="summary">
<meta name="twitter:description" content="Bring your business out of the Stone Age with the innovative web, Android and iOS development services from Fooyo in Singapore. Call (+65) 8412 7233 today!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
<meta name="twitter:title" content="Android and IOS App Developer Singapore">
		 <title>Android and IOS App Developer Singapore</title>
	...
	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/en-anli.css">
...
<?php get_header();?>
	  	...
	  	<div class="banner">
	  		<h2>Businesses innovation with<br><em>Simplicity</em></h2>
	  	...
	  	<div class="anli-show">
	  		...
	  		<h2><span><img src="<?php bloginfo('template_url'); ?>/images/line_03.jpg" alt="">Choose by category<img src="<?php bloginfo('template_url'); ?>/images/line_03.jpg" alt=""></span></h2>
	  		...
	  		<div class="show-content">
	  			<ul>
						<?php query_posts('cat=84'); while(have_posts()): the_post(); ?>   
  							<li><a href="<?php the_permalink(); ?>">
	  					<?php   the_post_thumbnail( 'full' );  ?>
	  					</a>
	  					</li>
						<?php endwhile; wp_reset_query(); ?>
						<li><img src="<?php bloginfo('template_url'); ?>/images/anli_3_14.png" alt=""></li>
	  			</ul>
	  			<ul>
	  			<?php query_posts('cat=90'); while(have_posts()): the_post(); ?>   
  							<li><a href="<?php the_permalink(); ?>">
	  					<?php   the_post_thumbnail( 'full' );  ?>
	  					</a>
	  					</li>
	  			...
	  			<ul>
	  						<?php query_posts('cat=86'); while(have_posts()): the_post(); ?>   
  							<li><a href="<?php the_permalink(); ?>">
	  					<?php   the_post_thumbnail( 'full' );  ?>
	  					</a>
	  					</li>
						...
						<li><img src="<?php bloginfo('template_url'); ?>/images/anli_3_14.png" alt=""></li>
	  				  			...
	  				  			<ul>
	  				<?php query_posts('cat=82'); while(have_posts()): the_post(); ?>   
  							<li><a href="<?php the_permalink(); ?>">
	  					<?php   the_post_thumbnail( 'full' );  ?>
	  					</a>
	  					</li>
						...
						<li><img src="<?php bloginfo('template_url'); ?>/images/anli_3_14.png" alt=""></li>
	  				  			...
	  				  			<ul>
	  							<?php query_posts('cat=88'); while(have_posts()): the_post(); ?>   
  							<li><a href="<?php the_permalink(); ?>">
	  					<?php   the_post_thumbnail( 'full' );  ?>
	  					</a>
	  					</li>
						...
						<li><img src="<?php bloginfo('template_url'); ?>/images/anli_3_14.png" alt=""></li>
	  				  			...
	  				  			<ul>
	  		  							<?php query_posts('cat=80'); while(have_posts()): the_post(); ?>   
  							<li><a href="<?php the_permalink(); ?>">
	  					<?php   the_post_thumbnail( 'full' );  ?>
	  					</a>
	  					</li>
	  	...
	  	<script type="text/javascript">
	  		!(function($){
	  			$('.show-title li').on('click',function(e){
	  				var index=$(this).index();
	  				$(this).addClass('active').siblings('li').removeClass('active');
	  				$('.show-content > ul').eq(index).css('display','flex').siblings('ul').hide();
	  			})
	  		})(jQuery)
	  	</script>
	</div>
 ...
 echo 	$goal;
	?>"
	if(goal!=""){
	$(".show-title>li").each(function(index, el) {//检测字段为true
	/* if($(this).text().test(goal)==true){
	 	//$(this).addClass('active').siblings().removeClass('active')
	 	//$(".show-content>ul").eq(index).css("display","flex").siblings().hide()
	 }*/
	var str=$(this).text();
...
$(".show-content ul").each(function(index, el) {
