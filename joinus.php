...
<head>
	<meta charset="UTF-8">
<title>加入我们 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品</title>
<meta name="robots" content="noodp">
<link rel="canonical" href="http://www.fooyo.sg/zh/%e5%8a%a0%e5%85%a5%e6%88%91%e4%bb%ac/">
<meta property="og:locale" content="zh_CN">
<meta property="og:locale:alternate" content="en_US">
<meta property="og:type" content="article">
<meta property="og:title" content="加入我们 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
<meta property="og:url" content="http://www.fooyo.sg/zh/%e5%8a%a0%e5%85%a5%e6%88%91%e4%bb%ac/">
<meta property="og:site_name" content="Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="加入我们 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/reset.css">
  	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/common.css">
  	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/style.css">
  	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/joinus.css">
...
<?php get_header();?>
		...
		<div class="banner">
			<img src="<?php bloginfo('template_url'); ?>/images/fooyo_zh_joinus_02.jpg">
		</div>
		<div class="rec">
			<figure>
				<figcaption>开发职位</figcaption>
				<div>
					<div class="img-wrap">
						<img src="<?php bloginfo('template_url'); ?>/images/join_rec-1_05.png" alt="">
					</div>
					<ul class="kaifa">
						<li>
							
						<?php query_posts('cat=36'); while(have_posts()):  ?>   
  						<p><?php the_post(); ?><span><?php  the_title();?></span>
			...
			<figure>
				<figcaption>设计职位</figcaption>
				<div>
					<div class="img-wrap">
						<img src="<?php bloginfo('template_url'); ?>/images/join_rec_2_09.png" alt="">
					</div>
					<ul class="design">
						<li>
							<?php query_posts('cat=37'); while(have_posts()):  ?>   
  						<p><?php the_post(); ?><span><?php  the_title();?></span>
			...
			<div class="resume">
				有兴趣的朋友请发邮件到<a href="mailto:jobs@fooyo.sg">jobs@fooyo.sg</a>
			</div>
			<div id="share">
	    		<p>分享</p>
				<div class="icon">
...
for(i=0;i<$("figure>div>.kaifa>li>p").length;i++){
	$("figure>div>.kaifa>li>p").eq(i).append($("figure>div>.kaifa>li>p").eq(i+1).children('span'))
	$("figure>div>.kaifa>li>p").eq(i+1).remove()

}
for(i=0;i<$("figure>div>.design>li>p").length;i=i+1){
	$("figure>div>.design>li>p").eq(i).append($("figure>div>.design>li>p").eq(i+1).children('span'))
	$("figure>div>.design>li>p").eq(i+1).remove()
