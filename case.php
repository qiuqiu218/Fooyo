...
<head>
	<meta charset="UTF-8">
	 <title>案例 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品</title>
<meta name="robots" content="noodp">
<link rel="canonical" href="http://www.fooyo.sg/zh/%e6%a1%88%e4%be%8b/">
<meta property="og:locale" content="zh_CN">
<meta property="og:locale:alternate" content="en_US">
<meta property="og:type" content="article">
<meta property="og:title" content="案例 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
<meta property="og:url" content="http://www.fooyo.sg/zh/%e6%a1%88%e4%be%8b/">
<meta property="og:site_name" content="Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="案例 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
      <meta name=“description” content=" 浮游科技">
		<meta property="og:title" content="Fooyo浮游科技|和浮游, 一起打造梦想的科技产品案例 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
		<meta property="og:url" content="http://www.fooyo.sg/zh/%e6%a1%88%e4%be%8b/">
		<meta property="og:site_name" content="Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
	...
	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/anli.css">
...
<?php get_header();?>
	  	...
	  	<div class="anli-show">
	  		...
	  		<h2><span><img src="<?php bloginfo('template_url'); ?>/images/line_03.jpg" alt="">案例展示
	  		<img src="<?php bloginfo('template_url'); ?>/images/line_03.jpg" alt=""></span></h2>
	  		<p>我们为您的项目创造优秀的用户界面和与出众的产品体验 已为多家国内外企业服务，项目案例遍及各行各业。</p>
	  		<ul class="show-title">
	  			<li class="active">教育科技</li>
	  			<li>餐饮</li>
	  			<li>旅行</li>
	  			<li>医疗服务</li>
	  			<li>物联网</li>
	  		...
	  		<div class="show-content">
	  			<ul>
						<?php query_posts('cat=18'); while(have_posts()): the_post(); ?>   
	  			...
	  			<ul>
	  			<?php query_posts('cat=19'); while(have_posts()): the_post(); ?>   
  							<li><a href="<?php the_permalink(); ?>">
	  					<?php   the_post_thumbnail( 'full' );  ?>
	  					</a>
	  					</li>
	  			...
	  			<ul>
						...
						<li><img src="<?php bloginfo('template_url'); ?>/images/anli_3_14.png" alt=""></li>	
	  				  			...
	  				  			<ul>
	  				<?php query_posts('cat=21'); while(have_posts()): the_post(); ?>   
  							<li><a href="<?php the_permalink(); ?>">
	  					<?php   the_post_thumbnail( 'full' );  ?>
	  					</a>
	  					</li>
