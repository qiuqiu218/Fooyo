...
<head>
  ...
  <meta name="description" content="Fooyo specialises in creating clean, modern and intuitive apps for iOS and Android to help businesses in Singapore offer an improved user experience.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
  <meta name="robots" content="noodp">
  <meta property="og:title" content="Fooyo|With fooyo, building dreamsAndriod and iOS Application Development Singapore | Fooyo">
  <meta property="og:url" content="http://www.fooyo.sg/">
  <meta property="og:site_name" content="Fooyo|With fooyo, building dreams">
  <meta property="og:image" content="http://www.fooyo.sg/wp-content/uploads/2015/10/home.png">
  <meta name="twitter:card" content="summary">
  <meta name="twitter:title" content="Andriod and iOS Application Development Singapore | Fooyo">
  <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/reset.css">
  <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/common.css">

  <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/en-style.css">
  <link rel="stylesheet" href="http://at.alicdn.com/t/font_jhj8p6w00wqxgvi.css">
  <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/jquery.fullPage.css">
  <script src='<?php bloginfo('template_url'); ?>/js/rem.js'></script>
  ...
  <link href="<?php bloginfo('template_url'); ?>/css/swiper-3.3.1.min.css" rel="stylesheet">
  <title>Andriod and iOS Application Development Singapore | Fooyo</title>
</head>
<body>
 <div class="top">
 <div class="seo">
   <h1>
 top mobile app development company Singapore
 app design and app development company Singapore 
 <h2> <i>experienced mobile app company in Singapore </i>
 website design and app development company singapore </h2>
</h1>
 </div>
    <h1>
...
<?php get_header();?>
  ...
  <script>
  $(".lan").append($('.lang-item>a'))
    $(".lang-item").remove()
  </script>
   <div id="fullpage">
    <div class="page page1 current section"  id="section0">
        <div class="contain">
            <section id='one' >
              <div class="f"></div>
              <div class="f"></div>
              ...
              <div class="f"></div>
              <div class="triangle">
                <canvas id="c1" width="420" height="622"></canvas>
              </div>
              <h2>We are<span></span><em></em></h2>
              <a href="javascript:;" class="aircraft"></a>
            </section>
        </div>
    </div>
    <div class="page page2 section"  id="section1">
        <div class="contain">
            <section id='two'>
            <canvas id="pixie" style="position: absolute;left: 0;top: 0;"></canvas>
              <div class="h2">
                <div>
                  <p>浮</p>
                  <p>游</p>
                ...
                <small>fooyo</small>
                          <?php 
$category_id = get_cat_ID( 'About'); 
$category_link = get_category_link( $category_id ); 
?> 
              </div>
              <p class="content">Fooyo is a technology consulting firm.</p>
              <p class="content">We offer both website and mobile application development to help scale new products and ideas.</p>
              <p class="content">We help you win with solutions that reflect your needs and goals,</p>
              <p class="content">improve brand image and transform user experience.</p>
             
              <a class="link" href="<?php echo $category_link; ?>">More>></a>
            </section>
        </div>
    </div>
  <div class="page page3 section" id="section2">
        <div class="contain">
            <section id='three'>
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide" style="padding:0 18%;">
                    <div class="earth">
                      <img src="<?php bloginfo('template_url'); ?>/images/air_en.gif" alt=" ios developer company singapore">
                    </div>
                    <div class="h2">
                      <p>Global Insights</p>
                      <div>
                        <p>Fooyo works together with innovative companies and entrepreneurs all over the world to create innovative</em> products and services in the website and mobile app fields.</p>
                        
                      </div>
                      <div>
                        <p>No matter  where you are from, what  language  you are speaking  and what  market  you are targeting,  we  are always  ready for help. </p>
                  ...
                  <div class="swiper-slide">
                    <div class="h2">
                      <p>Expertise and Innovative</p>
                      <small>From 0 to 1</small>
                      <div>
                        <p>We work closely with  our clients and partners to build products from a scratch.  We takes the needs of our clients seriously and goes  above and beyond to ensurethat the final result meets and exceeds expectations across the board.  
                      </p>
                  ...
                  <div class="swiper-slide">
                    <div class="step">
                      ...
                      <div class="design step-item">
                        <span class="number">2</span>
                        <small></small>
                        <em>UI/UX Design</em>
                      </div>
                      <div class="agile step-item">
                    ...
                    <div class="content">
                      <h2>Efficient and Professional</h2>
                      <small>We  adopt <em>agile development</em> methodologies to  deliver high-quality  products.</small>
                      <p>Projects are normally divided into 2 weeks' Springs.</p>
                      <p>In each Spring, there will be a deliverable working product version. </p>
                      <p>We move fast, improve continuously, response to changes.</p>
                ...
                <div class="swiper-button-next"></div>
                              ...
                              <?php 
$category_id = get_cat_ID( 'Cases'); 
$category_link = get_category_link( $category_id ); 
?> 
          <div class="page page4 section" id="section3">
          <div class="contain">
              <section id="four">
              <div class="ct">
                <div class="c1">
                  <a href="<?php echo $category_link."?goal=F"; ?>" class="mask">
                    <span>Food & Beverage</span>
                   
                    <p> As  the most  traditional industry, the Food  & Beverage  industry  is  faced with  promising potentials  as  well  as  critical  challenges  brought by  the popularity  of  the smart phone.  And Fooyo,  a team  addicted  to  both  delicious and technology, is  seeking its own way of  joining this  grand revolution.</p>
                  </a>
                </div>
                <div>
                  <div class="c2">
                    <a href="<?php echo $category_link."?goal=Healthcare"; ?>" class="mask">
                        <span>Healthcare</span>
                        
                        <p>Technology is  reconstructing  our daily life, with  the most  incredible  speed ever. As  more  and more  smart devices and services  coming  to  the market, the Healthcare  industry  is  at  the door  of  reform.</p>
                    </a>
                  </div>
                  <div>
                    <div class="c3">
                    <a href="<?php echo $category_link."?goal=Tourism"; ?>" class="mask">
                      <span>Tourism & Hospitality</span>
                     
                      <p>The Tourism & Hospitality industry  has been  benefited the most  from  the development of  mobile  internet. What’s next after Uber and Airbnb? You may have  the answer  and we  will  back  you up. </p>
                    </a>
                    </div>
                    <div class="c4">
                      <a href="<?php echo $category_link."?goal=Education"; ?>" class="mask">
                        <span>Education</span>
                        
                        <p>
                    From  the early management  system, to  nowadays  the online  learning  platform, and the AR/VR schools coming  in  the future, the Education industry  follows closely with  the technology  and together, they  make  lots  of  possibilities.  
                        </p>
                      </a>
                    </div>
                  </div>
                ...
                <div>
                  <div class="c5">
                    <a href="<?php echo $category_link."?goal=IoT"; ?>" class="mask">
                      <span>IoT</span>
                      
                      <p>IoT is happening around us. From Zuckerberg’s smart home AI to theme park’s  visitor flow tracking system,IoT is connecting every tiny part of our life and brings  new perspectives on how to make our life better. 
  </p>
                    </a>
                  </div>
                  <div class="other">
                    <div class="mask">
                      ...
                      <a href="<?php echo $category_link."?goal=Others"; ?>" class="link">Enter</a>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="page page5 section" id="section4">
        <div class="contain">
            <section id="five" >
              <img src="<?php bloginfo('template_url'); ?>/images/21.png" alt=" android application development company singapore   (too high competition - 17,300,000)" class="dec">
              <a href="http://42.96.189.31/?cat=100&lang=en" class="joinus">Join us</a>
  ...
  <script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/canvasRender.js"></script>
  <script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/fooyo.js"></script>
  <script src="<?php bloginfo('template_url'); ?>/js/en-app.js"></script>
  <script>
