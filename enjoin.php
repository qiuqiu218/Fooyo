...
<head>
	<meta charset="UTF-8">
	  <title><?php if ( is_home() ) {
		...
		<meta property="og:title" content="Fooyo|With fooyo, building dreamsContact Us">
		<meta property="og:url" content="http://www.fooyo.sg/contact-us/">
	...
	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/reset.css">
  	...
  	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/enjoinus.css">
...
<body>
	<div class="join-us">
		<div class="top">
			...
			<div class="banner">
			<img src="<?php bloginfo('template_url'); ?>/images/fooy_join_banner.jpg">
		</div>
		<div class="rec">
			<figure>
				<figcaption>Development Roles</figcaption>
				<div>
					<div class="img-wrap">
					...
					<ul class="kaifa">
						...
						<?php query_posts('cat=105'); while(have_posts()):  ?>   
			...
			<figure>
				<figcaption>Design Roles</figcaption>
				<div>
					<div class="img-wrap">
						<img src="<?php bloginfo('template_url'); ?>/images/design.png" alt="">
					</div>
					<ul class="design">
						<li>
							<?php query_posts('cat=103'); while(have_posts()):  ?>   
  						<p><?php the_post(); ?><span><?php  the_title();?></span>
			...
			<div class="resume">
				Interested Candidates Please Email To <a href="mailto:jobs@fooyo.sg">jobs@fooyo.sg</a>
			</div>
			<div id="share">
	    		<p>share on</p>
				<div class="icon">
