...
<head>
	<meta charset="UTF-8">
<title>关于 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品</title>
<meta name="robots" content="noodp">
<link rel="canonical" href="http://www.fooyo.sg/zh/%e5%85%b3%e4%ba%8e/">
...
<?php get_header();?>
	  	...
	  	<div class="bg">
	  		...
	  		<p class="intro">浮游(Fooyo)是一种简单和自由的状态</p>
	  		<p class="t">出生</p>
	  		<p class="c">2014年4月,四个年轻人组建了一个微信群，</p>
	  		<p class="c">在瑞士苏黎世联邦理工交流的Rick，在加拿大滑铁卢大学交换的Zeyu，在新加坡的Shao和Zing。</p>
	  		<p class="c">我们的初衷是建立一个小而美的技术公司打造高 品位的产品。</p>
	  		<p class="c">我们命名为“浮游”，因为它代表简单和纯粹，象征着美丽和自由。</p>
	  	</div>
	  		 <div class="brand">
		 	<div class="inner">
		 		...
		 		<div>
		 			<h2 class="t">品牌</h2>
		 			<p class="c first">品牌的颜色是受到泰国的Ko Tao岛的启发。</p>
		 			<p class="c">并没有用传统的IT蓝色，设计师Keyan选择了薄荷绿和深海蓝，更清新更活力。</p>
		 			<p class="c bottom">“ 那是自然界清澈大海的颜色，非常美。四种不同的蓝色象征着这是一个小而美又蕴含巨大的潜力的公司。”</p>
		 		</div>
		 	</div>
		 </div>
	  	<div class="color">
		 ...
		 <div class="team">
		 	<div>
		 		<h2>我们的团队</h2>
		 		<p>我们是一群对创造好用的产品充满热情，希望解决世界上真实存在的问题，让人们生活变得更好的专业人士。</p>
		 	</div>
		 	<div class="img-boxs">
		...
		<?php while(have_posts()):the_post();?>
			...
			<li  class="img-box">
		 		...
		 		<div class="boxT" style="background-image: url('<?php the_post_thumbnail_url();?>')"></div>
