...
<link rel="canonical" href="http://www.fooyo.sg/zh/%e6%9c%8d%e5%8a%a1/">
<meta property="og:locale" content="zh_CN">
<meta property="og:locale:alternate" content="en_US">
<meta property="og:type" content="article">
<meta property="og:title" content="服务 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
<meta property="og:url" content="http://www.fooyo.sg/zh/%e6%9c%8d%e5%8a%a1/">
<meta property="og:site_name" content="Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="服务 | Fooyo浮游科技|和浮游, 一起打造梦想的科技产品">
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/jquery.fullPage.css">
...
<?php get_header();?>
		...
		<div class="banner">
			<h2><em>浮游</em>服务</h2>
			<div>
				<p>浮游，作为新加坡顶级技术咨询公司，提供从<em>0到1</em>的产品创新服务。</p>
				<p>基于敏捷开发思维模式,我们与全球的企业合 作，小伙伴遍布东南亚、美国、中国、日本等。</p>
				<p>我们了解大中小型企业的商业模式及产品需求，我们倡导让客户感知产品的应用体验价值，而不仅仅是产品的功能。</p>
			</div>
		</div>
		<ul class="tec clearfix">
			
			<?php query_posts('cat=123'); while(have_posts()): the_post(); ?>   
  						<li>
		...
		<div class="content">
			<h2>从0到1</h2>
			<p>我们非常享受与客户与合作伙伴一起从零开始把打造产品。<br>我们会因为产品被千千万万的用户 喜欢而感到兴奋。</p>
			...
			<div class="swiper-container">
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<ul class="clearfix">
							<?php query_posts('cat=117'); while(have_posts()): the_post(); ?>   
  							<li>
	  					<?php   the_post_thumbnail( 'full' );  ?>
	  					<p><?php the_title();?></p>
	  					</li>
						...
						<?php query_posts('cat=125'); while(have_posts()): the_post(); ?> 
							<small><?php the_content();?></small>
							<?php endwhile; wp_reset_query(); ?>
					</div>
					<div class="swiper-slide">
						<ul class="clearfix">
						<?php query_posts('cat=119'); while(have_posts()): the_post(); ?>   
  							<li>
	  					<?php   the_post_thumbnail( 'full' );  ?>
	  					<p><?php the_title();?></p>
	  					</li>
						...
						<?php query_posts('cat=129'); while(have_posts()): the_post(); ?> 
							<small><?php the_content();?></small>
										<?php endwhile; wp_reset_query(); ?>
					</div>
					<div class="swiper-slide">
						<ul class="clearfix">
							<?php query_posts('cat=121'); while(have_posts()): the_post(); ?>   
  							<li>
	  					<?php   the_post_thumbnail( 'full' );  ?>
	  					<p><?php the_title();?></p>
	  					</li>
						<?php endwhile; wp_reset_query(); ?>
						</ul><?php query_posts('cat=127'); while(have_posts()): the_post(); ?> 
							<small><?php the_content();?></small>
							<?php endwhile; wp_reset_query(); ?>
					</div>
				</div>
